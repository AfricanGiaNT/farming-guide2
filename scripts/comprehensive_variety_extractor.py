#!/usr/bin/env python3
"""
Comprehensive Variety Extractor - ALL Crops
Extract varieties from every crop in Chapter 3
"""
...
class ComprehensiveVarietyExtractor:
    """
    Extract varieties from ALL crops in Chapter 3
    """
    ...
    def __init__(self):
        ...
        # ALL variety table locations found in analysis
        self.crop_variety_pages = {
            # Cereals
            "maize": [156, 167],  # Tables 17a, 17b, 21
            "rice": [170],        # Table 23
    ...
    def extract_crop_varieties(self, crop_name: str) -> Set[str]:
        ...
        print(f"  Found: {len(all_varieties)} varieties")
        if all_varieties:
            print(f"  Varieties: {sorted(all_varieties)}")
...
def main():
    print("=" * 80)
    print("COMPREHENSIVE VARIETY EXTRACTION - ALL CROPS")
    print("Guide to Agriculture Production in Malawi 2021 - Chapter 3")
    print("Extracting from ALL variety tables found")
    print("=" * 80)
    
    extractor = ComprehensiveVarietyExtractor()
    
    # ALL crops with variety tables
    crops_to_extract = [
    ...
    print("\n" + "=" * 80)
    print("SUCCESS: Comprehensive variety extraction completed!")
    print("All varieties extracted from Chapter 3 variety tables")
    print("=" * 80 + "\n")
